      ...
      children: [
        Column(
          ...
          children: [
            ...
            if (subLabel.validate().isNotEmpty) Text(subLabel!, style: secondaryTextStyle(size: 12)).paddingTop(6),
          ],
        ),
        TextButton(
          onPressed: isViewAllVisible(list)
              ...
              : null,
          child: isViewAllVisible(list) ? Text(context.translate.viewAll, style: secondaryTextStyle()) : SizedBox(),
        )
      ],
    );
  }
