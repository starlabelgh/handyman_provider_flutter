        ...
        children: [
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                cachedImage(
                  data.imageAttachments!.isNotEmpty ? data.imageAttachments!.first.validate() : "",
                  fit: BoxFit.cover,
                  height: 180,
                  width: context.width(),
          ...
          Column(
            ...
            children: [
              ...
              Marquee(
                directionMarguee: DirectionMarguee.oneDirection,
                child: Text(data.name.validate(), style: boldTextStyle(size: 16)).paddingSymmetric(horizontal: 16),
              ),
              16.height,
            ],
          ),
